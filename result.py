...
df = pd.read_csv(r'D:\Work\import-two-man\results\predict.csv')
predict_table = pd.read_csv(r'D:\Work\import-two-man\data\predict_table.csv')
scalar = joblib.load(r'D:\Work\import-two-man\scalar\scalar_train_and_covariates_2')
m = scalar.mean_
std = scalar.scale_
...
res.to_csv(r'D:\Work\import-two-man\data\result_0726.csv', index=False, sep=',')
